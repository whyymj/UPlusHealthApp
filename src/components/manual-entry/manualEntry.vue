  ...
  <div ref="manualEntry" class="page manual-entry">
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('measureDate')"
		      					v-model="measureDay">
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('measureTime')"
		      					v-model="measureTime">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasurePeriod('measurePeriod')"
		      					v-model="measurePeriod.name">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
		      	</div>
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('pressureDate')"
		      					v-model="pressureDay">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('pressureTime')"
		      					v-model="pressureTime">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
		      	</div>
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('temperatureDate')"
		      					v-model="temperatureDay">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
		      		<div class="measure-row">
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('temperatureTime')"
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('weightDate')"
		      					v-model="weightDay">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
		      			...
		      			<div class="measure-item-slt">
		      				<input type="text"
		      					readonly
										unselectable="on"
										onfocus="this.blur()"
		      					@click="openMeasureDate('weightTime')"
		      					v-model="weightTime">
		            		<i class="fa fa-angle-right"></i>
		      			</div>
		      		</div>
    ...
    <!--血糖日期选择-->
		<div @touchmove.prevent>
			<mt-datetime-picker
				ref="measureDate"
				v-model="measureDefaultDay"
				type="date"
				year-format="{value} 年"
				month-format="{value} 月"
				date-format="{value} 日"
				:endDate="new Date()"
				@confirm="handleMeasureDay">
			</mt-datetime-picker>
		</div>
    <div @touchmove.prevent>
			<mt-datetime-picker
				ref="measureTime"
				v-model="measureDefaultTime"
				type="time"
				:endHour="endHour"
				@confirm="handleMeasureTime">
			</mt-datetime-picker>
		</div>
    ...
    <!--血压日期选择-->
		<div @touchmove.prevent>
			<mt-datetime-picker
				ref="pressureDate"
				v-model="pressureDefaultDay"
				type="date"
				year-format="{value} 年"
				month-format="{value} 月"
				date-format="{value} 日"
				:endDate="new Date()"
				@confirm="handlePressureDay">
			</mt-datetime-picker>
		</div>
    <div @touchmove.prevent>
			<mt-datetime-picker
				ref="pressureTime"
				v-model="pressureDefaultTime"
				type="time"
				:endHour="endHour"
				@confirm="handlePressureTime">
			</mt-datetime-picker>
		</div>
		...
		<div @touchmove.prevent>
			<mt-datetime-picker
				ref="temperatureDate"
				v-model="temperatureDefaultDay"
				type="date"
				year-format="{value} 年"
				month-format="{value} 月"
				date-format="{value} 日"
				:endDate="new Date()"
				@confirm="handleTemperatureDay">
			</mt-datetime-picker>
		</div>
		<div @touchmove.prevent>
			<mt-datetime-picker
				ref="temperatureTime"
				v-model="temperatureDefaultTime"
				type="time"
				:endHour="endHour"
				@confirm="handleTemperatureTime">
			</mt-datetime-picker>
		</div>
		...
		<div @touchmove.prevent>
			<mt-datetime-picker
				ref="weightDate"
				v-model="weightDefaultDay"
				type="date"
				year-format="{value} 年"
				month-format="{value} 月"
				date-format="{value} 日"
				:endDate="new Date()"
				@confirm="handleWeightDay">
			</mt-datetime-picker>
		</div>
		<div @touchmove.prevent>
			<mt-datetime-picker
				ref="weightTime"
				v-model="weightDefaultTime"
				type="time"
				:endHour="endHour"
				@confirm="handleWeightTime">
			</mt-datetime-picker>
		</div>
...
<script type="text/javascript" src="./manualEntry.js"></script>
