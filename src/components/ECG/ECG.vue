  ...
  <div class="page ecg-page">
    <!-- <h-header title="心电"></h-header> -->
      <mycollapse2 animateT='500'>
        <div>
          <myDatePicker @checkDateData='checkDateData' flag='5'></myDatePicker>
        </div>
      </mycollapse2>
    <div class="container has-footer">
      ...
      <div :class="['calendar-below', {'open' : calendarOpen}]" id="calendarBelow">
        <div ref="noData" class="ecg-record no-record card-container">
          <div>
        ...
        <div class="ecg-record-list-c">
          <div v-for="(item, index) in ecgRecordData" :key="index" :class="['ecg-record-list', 'card-container', {'ecg-toggle': index + 1 === ecgIndex}]">
            <mt-cell-swipe :right="[
                  {
          ...
          <div ref="allData" class="ecg-record-list card-container" style="display: none" @click="fnGetAllData()">
