// Ion.Calendar version 2.0.1, build: 91 © 2013 Denis Ineshin | IonDen.com
//
// Project page:    http://ionden.com/a/plugins/ion.calendar/ GitHub page:
// https://github.com/IonDen/ion.calendar
//
// Released under MIT licence: http://ionden.com/a/plugins/licence-en.html
// =============================================================================
// = =======================================
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var prepareCalendar = function () {
                    ...
                    console.log('settings>>s',timeNowLocal, timeForWork);
                    ...
                    for (i = 0; i < 12; i++) {
                        if (i === parseInt(timeNowLocal.format("M")) - 1) {
                            html += '<option value="' + i + '" selected="selected">' + timeForWork
                                .month(i)
                                .format("MMMM") + '</option>';
                        } else {
                            html += '<option value="' + i + '">' + timeForWork
                                .month(i)
                                .format("MMMM") + '</option>';
                        }
                    }
                ...
                var placeCalendar = function () {
                    ...
                    window.myChnageMonth = function () {
                        var toMonth = window.mySelectedMonth || $(this).prop("value");
                        timeNowLocal.month(parseInt(toMonth));
                        $month.prop('value', timeNowLocal)
                        removeHTML();

                    };
                    window.myChnageYear = function () {
                        var toYear = window.mySelectedYear || $(this).prop("value");
                        timeNowLocal.year(parseInt(toYear));
                        $year.prop('value',window.mySelectedYear);
                        removeHTML();
                    };
                    $month.on("change", function (e) {
                        e.preventDefault();
                        var toMonth = window.selectedMonth || $(this).prop("value");
                        timeNowLocal.month(parseInt(toMonth));
                        removeHTML();
                    });
                    $year.on("change", function (e) {
                        e.preventDefault();
                        var toYear = window.selectedYear || $(this).prop("value");
                        timeNowLocal.year(parseInt(toYear));
                                ...
                                if (typeof settings.onClick === "function") {
                                    if (settings.format) {
                                        if (settings.format === "moment") {
                                            settings
                                                .onClick
                                                .call(this, timeSelected);
                                        } else {
                                            settings
                                                .onClick
                                                .call(this, timeSelected.format(settings.format));
                                        }
                                    } else {
                                        settings
                                            .onClick
                                            .call(this, timeSelected.format());
                                    }
                                }
                    ...
                    if (typeof settings.onReady === "function") {
                        if (settings.format) {
                            if (settings.format === "moment") {
                                settings
                                    .onReady
                                    .call(this, timeNowLocal);
                            } else {
                                settings
                                    .onReady
                                    .call(this, timeNowLocal.format(settings.format));
                            }
                        } else {
                            settings
                                .onReady
                                .call(this, timeNowLocal.format());
                        }
                    }
...
// =============================================================================
// ======================================== Ion.DatePicker support plugin for
// ion.calendar
            ...
            return this.each(function () {
                ...
                var openPopup = function () {
                    ...
                    if (currentDate && currentDate !== selectedDate && settings.format.indexOf("L") < 0) {
                        ...
                        if (testDate.isValid()) {
                            $popup.ionCalendar("update", {startDate: currentDate});
                        }
                    }
